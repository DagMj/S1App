...
class Disposal(IntEnum):
    ...
    OP_BACKGROUND = 1
    """
    This frameÃ¢â‚¬â„¢s modified region is cleared to fully transparent black before rendering
    the next frame.
    See :ref:`Saving APNG sequences<apng-saving>`.
    """
    OP_PREVIOUS = 2
    """
    This frameÃ¢â‚¬â„¢s modified region is reverted to the previous frameÃ¢â‚¬â„¢s contents before
