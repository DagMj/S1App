...
class _UnicodeFixture(_LiteralRoundTripFixture, fixtures.TestBase):
    ...
    data = (
        "Alors vous imaginez ma Ã°Å¸ÂÂ surprise, au lever du jour, "
        "quand une drÃƒÂ´le de petite Ã°Å¸ÂÂ voix mÃ¢â‚¬â„¢a rÃƒÂ©veillÃƒÂ©. Elle "
        "disait: Ã‚Â« SÃ¢â‚¬â„¢il vous plaÃƒÂ®tÃ¢â‚¬Â¦ dessine-moi Ã°Å¸ÂÂ un mouton! Ã‚Â»"
    )
    ...
    def test_literal_non_ascii(self, literal_round_trip):
        literal_round_trip(self.datatype, ["rÃƒÂ©veÃ°Å¸ÂÂ illÃƒÂ©"], ["rÃƒÂ©veÃ°Å¸ÂÂ illÃƒÂ©"])
...
class ArrayTest(_LiteralRoundTripFixture, fixtures.TablesTest):
    ...
    def test_array_roundtrip(self, connection):
        ...
        connection.execute(
            array_table.insert(),
            {
                "id": 1,
                "single_dim": [1, 2, 3],
                "multi_dim": [["one", "two"], ["thr'ee", "rÃƒÂ©veÃ°Å¸ÂÂ illÃƒÂ©"]],
            },
        )
        row = connection.execute(
            select(array_table.c.single_dim, array_table.c.multi_dim)
        ).first()
        eq_(row, ([1, 2, 3], [["one", "two"], ["thr'ee", "rÃƒÂ©veÃ°Å¸ÂÂ illÃƒÂ©"]]))
    ...
    def test_literal_complex(self, literal_round_trip):
        literal_round_trip(
            ...
            ([["one", "two"], ["thr'ee", "rÃƒÂ©veÃ°Å¸ÂÂ illÃƒÂ©"]],),
            ([["one", "two"], ["thr'ee", "rÃƒÂ©veÃ°Å¸ÂÂ illÃƒÂ©"]],),
            support_whereclause=False,
        )
...
class TextTest(_LiteralRoundTripFixture, fixtures.TablesTest):
    ...
    def test_literal_non_ascii(self, literal_round_trip):
        literal_round_trip(Text, ["rÃƒÂ©veÃ°Å¸ÂÂ illÃƒÂ©"], ["rÃƒÂ©veÃ°Å¸ÂÂ illÃƒÂ©"])
...
class StringTest(_LiteralRoundTripFixture, fixtures.TestBase):
    ...
    @requirements.unicode_data_no_special_types
    def test_literal_non_ascii(self, literal_round_trip):
        literal_round_trip(String(40), ["rÃƒÂ©veÃ°Å¸ÂÂ illÃƒÂ©"], ["rÃƒÂ©veÃ°Å¸ÂÂ illÃƒÂ©"])
...
class JSONTest(_LiteralRoundTripFixture, fixtures.TablesTest):
    ...
    def test_round_trip_pretty_large_data(self, connection, unicode_, length):
        if unicode_:
            data = "rÃƒÂ©veÃ°Å¸ÂÂillÃƒÂ©" * ((length // 9) + 1)
    ...
    def _index_fixtures(include_comparison):
        ...
        elements = [
            ...
            ("string", "some string"),
            ("string", None),
            ("string", "rÃƒÂ©ve illÃƒÂ©"),
            (
                "string",
                "rÃƒÂ©veÃ°Å¸ÂÂ illÃƒÂ©",
        ...
        with config.db.begin() as conn:
            conn.execute(
                self.tables.data_table.insert(),
                {
                    "name": "r1",
                    "data": {
                        "rÃƒÂ©veÃ°Å¸ÂÂ illÃƒÂ©": "rÃƒÂ©veÃ°Å¸ÂÂ illÃƒÂ©",
                        "data": {"k1": "drÃƒÂ´lÃ°Å¸ÂÂe"},
                    },
                },
            )
...
class EnumTest(_LiteralRoundTripFixture, fixtures.TablesTest):
    ...
    enum_values = "a", "b", "a%", "b%percent", "rÃƒÂ©veillÃƒÂ©"
    ...
    def test_round_trip_executemany_returning(self, connection):
        ...
        eq_(result.scalars().all(), ["b%percent", "rÃƒÂ©veillÃƒÂ©", "b", "a%"])
