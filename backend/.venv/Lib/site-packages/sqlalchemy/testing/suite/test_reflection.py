...
class ComponentReflectionTest(ComparesTables, OneConnectionTablesTest):
    ...
    def test_comments_unicode(self, connection, metadata):
        Table(
            "unicode_comments",
            metadata,
            Column("unicode", Integer, comment="ÃƒÂ©Ã¨Â©Â¦Ã¨â€ºâ€¡Ã¡ÂºÅ¸ÃŽÂ©"),
            Column("emoji", Integer, comment="Ã¢ËœÂÃ¯Â¸ÂÃ¢Å“Â¨"),
            comment="Ã¨Â©Â¦Ã¨â€ºâ€¡Ã¡ÂºÅ¸ÃŽÂ©Ã¢Å“Â¨",
        )
        ...
        eq_(tc, {"text": "Ã¨Â©Â¦Ã¨â€ºâ€¡Ã¡ÂºÅ¸ÃŽÂ©Ã¢Å“Â¨"})

        cols = insp.get_columns("unicode_comments")
        value = {c["name"]: c["comment"] for c in cols}
        exp = {"unicode": "ÃƒÂ©Ã¨Â©Â¦Ã¨â€ºâ€¡Ã¡ÂºÅ¸ÃŽÂ©", "emoji": "Ã¢ËœÂÃ¯Â¸ÂÃ¢Å“Â¨"}
        eq_(value, exp)
    ...
    def test_comments_unicode_full(self, connection, metadata):
        Table(
            "unicode_comments",
            metadata,
            Column("emoji", Integer, comment="Ã°Å¸ÂÂÃ°Å¸Â§â„¢Ã°Å¸ÂÂÃ°Å¸Â§â„¢Ã¢â‚¬ÂÃ¢â„¢â€šÃ¯Â¸ÂÃ°Å¸Â§â„¢Ã¢â‚¬ÂÃ¢â„¢â‚¬Ã¯Â¸Â"),
            comment="Ã°Å¸Å½Â©Ã°Å¸ÂÂ°Ã°Å¸Ââ€˜Ã°Å¸Â¤Â·Ã¢â‚¬ÂÃ¢â„¢â‚¬Ã¯Â¸ÂÃ°Å¸Â¤Â·Ã¢â‚¬ÂÃ¢â„¢â€šÃ¯Â¸Â",
        )
        ...
        insp = inspect(connection)
        tc = insp.get_table_comment("unicode_comments")
        eq_(tc, {"text": "Ã°Å¸Å½Â©Ã°Å¸ÂÂ°Ã°Å¸Ââ€˜Ã°Å¸Â¤Â·Ã¢â‚¬ÂÃ¢â„¢â‚¬Ã¯Â¸ÂÃ°Å¸Â¤Â·Ã¢â‚¬ÂÃ¢â„¢â€šÃ¯Â¸Â"})
        c = insp.get_columns("unicode_comments")[0]
        eq_({c["name"]: c["comment"]}, {"emoji": "Ã°Å¸ÂÂÃ°Å¸Â§â„¢Ã°Å¸ÂÂÃ°Å¸Â§â„¢Ã¢â‚¬ÂÃ¢â„¢â€šÃ¯Â¸ÂÃ°Å¸Â§â„¢Ã¢â‚¬ÂÃ¢â„¢â‚¬Ã¯Â¸Â"})
