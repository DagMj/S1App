...
class _BaseUrl:
    ...
    def host(self) -> str | None:
        ...
        If the URL must be punycode encoded, this is the encoded host, e.g if the input URL is `https://Ã‚Â£Ã‚Â£Ã‚Â£.com`,
    ...
    def unicode_host(self) -> str | None:
        ...
        If the URL must be punycode encoded, this is the decoded host, e.g if the input URL is `https://Ã‚Â£Ã‚Â£Ã‚Â£.com`,
        `unicode_host()` will be `Ã‚Â£Ã‚Â£Ã‚Â£.com`
        """
    ...
    def unicode_string(self) -> str:
        ...
        If the URL must be punycode encoded, this is the decoded string, e.g if the input URL is `https://Ã‚Â£Ã‚Â£Ã‚Â£.com`,
        `unicode_string()` will be `https://Ã‚Â£Ã‚Â£Ã‚Â£.com`
        """
...
class HttpUrl(AnyUrl):
    ...
    * Max length 2083
    ...
    m1 = MyModel(url='http://punyÃ‚Â£code.com')
    print(m1.url)
    #> http://xn--punycode-eja.com/
    m2 = MyModel(url='https://www.ÃÂ°Ã‘â‚¬Ã‘â‚¬Ã“ÂÃÂµ.com/')
    print(m2.url)
    #> https://www.xn--80ak6aa92e.com/
    m3 = MyModel(url='https://www.example.Ã§ÂÂ Ã¥Â®Â/')
    print(m3.url)
