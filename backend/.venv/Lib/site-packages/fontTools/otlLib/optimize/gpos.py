...
class Cluster:
    ...
    def cost(self):
        return (
            ...
            + 2
            + self.coverage_bytes
            # uint16	valueFormat1	ValueRecord definition Ã¢â‚¬â€ for the first glyph of the pair (may be zero).
            + 2
            # uint16	valueFormat2	ValueRecord definition Ã¢â‚¬â€ for the second glyph of the pair (may be zero).
            + 2
            # Offset16	classDef1Offset	Offset to ClassDef table, from beginning of PairPos subtable Ã¢â‚¬â€ for the first glyph of the pair.
            + 2
            + self.classDef1_bytes
            # Offset16	classDef2Offset	Offset to ClassDef table, from beginning of PairPos subtable Ã¢â‚¬â€ for the second glyph of the pair.
            + 2
            + self.classDef2_bytes
            # uint16	class1Count	Number of classes in classDef1 table Ã¢â‚¬â€ includes Class 0.
            + 2
            # uint16	class2Count	Number of classes in classDef2 table Ã¢â‚¬â€ includes Class 0.
            + 2
    ...
    def coverage_bytes(self):
        format1_bytes = (
            ...
            # uint16	coverageFormat	Format identifier Ã¢â‚¬â€ format = 1
            # uint16	glyphCount	Number of glyphs in the glyph array
            4
            # uint16	glyphArray[glyphCount]	Array of glyph IDs Ã¢â‚¬â€ in numerical order
        ...
        format2_bytes = (
            ...
            # uint16	coverageFormat	Format identifier Ã¢â‚¬â€ format = 2
            # uint16	rangeCount	Number of RangeRecords
            4
            # RangeRecord	rangeRecords[rangeCount]	Array of glyph ranges Ã¢â‚¬â€ ordered by startGlyphID.
