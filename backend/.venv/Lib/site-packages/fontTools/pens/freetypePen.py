...
class FreeTypePen(BasePen):
    ...
    Examples:
        ...
        Combining with `uharfbuzz`, you can typeset a chunk of glyphs in a pen::
            ...
            en1, en2, ar, ja = 'Typesetting', 'Jeff', 'Ã˜ÂµÃ™Â Ã˜Â§Ã™â€žÃ˜Â­Ã˜Â±Ã™Ë†Ã™Â', 'Ã£ÂÅ¸Ã£Ââ€žÃ£ÂÂ·Ã£Ââ€ºÃ£ÂÂ£Ã£ÂÂ¨'
    ...
    def buffer(
        ...
        Notes:
            ...
            maintained but RSB wonÃ¢â‚¬â„¢t. The difference between the two becomes
    ...
    @property
    def cbox(self):
        """Returns an outline's Ã¢â‚¬Ëœcontrol boxÃ¢â‚¬â„¢.
