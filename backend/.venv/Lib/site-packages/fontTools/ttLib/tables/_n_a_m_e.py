...
class table__n_a_m_e(DefaultTable.DefaultTable):
    ...
    def findMultilingualName(
        ...
        such as {'en': 'Pale', 'de': 'BlaÃƒÅ¸', 'de-CH': 'Blass'}.
...
def _makeMacName(name, nameID, language, font=None):
    ...
    whose language points to the fontÃ¢â‚¬â„¢s 'ltag' table. The latter
    ...
    See the section Ã¢â‚¬Å“The language identifierÃ¢â‚¬Â in AppleÃ¢â‚¬â„¢s specification:
    ...
    if font is not None:
        ...
        # 0 = Unicode; 4 = Ã¢â‚¬Å“Unicode 2.0 or later semantics (non-BMP characters allowed)Ã¢â‚¬Â
        # Ã¢â‚¬Å“The preferred platform-specific code for Unicode would be 3 or 4.Ã¢â‚¬Â
        # https://developer.apple.com/fonts/TrueType-Reference-Manual/RM06/Chap6name.html
...
# Windows language ID Ã¢â€ â€™ IETF BCP-47 language tag
#
# While Microsoft indicates a region/country for all its language
# IDs, we follow Unicode practice by omitting Ã¢â‚¬Å“most likely subtagsÃ¢â‚¬Â
# as per Unicode CLDR. For example, English is simply Ã¢â‚¬Å“enÃ¢â‚¬Â and not
# Ã¢â‚¬Å“en-LatnÃ¢â‚¬Â because according to Unicode, the default script
...
_WINDOWS_LANGUAGES = {
    ...
    # Ã¢â‚¬Å“Spanish with modern sortingÃ¢â‚¬Â and Ã¢â‚¬Å“Spanish with traditional
    # sortingÃ¢â‚¬Â. This makes sense for collation APIs, and it would be
    # possible to express this in BCP 47 language tags via Unicode
    # extensions (eg., Ã¢â‚¬Å“es-u-co-tradÃ¢â‚¬Â is Ã¢â‚¬Å“Spanish with traditional
    # sortingÃ¢â‚¬Â). However, for storing names in fonts, this distinction
    # does not make sense, so we use Ã¢â‚¬Å“esÃ¢â‚¬Â in both cases.
    0x0C0A: "es",
    0x040A: "es",
    0x540A: "es-US",
    0x380A: "es-UY",
...
# MacOS language ID Ã¢â€ â€™ MacOS script ID
#
...
# done as a (pretty radical) Ã¢â‚¬Å“modificationÃ¢â‚¬Â of Ethiopic.
#
# http://unicode.org/Public/MAPPINGS/VENDORS/APPLE/Readme.txt
_MAC_LANGUAGE_TO_SCRIPT = {
    0: 0,  # langEnglish Ã¢â€ â€™ smRoman
    1: 0,  # langFrench Ã¢â€ â€™ smRoman
    2: 0,  # langGerman Ã¢â€ â€™ smRoman
    3: 0,  # langItalian Ã¢â€ â€™ smRoman
    4: 0,  # langDutch Ã¢â€ â€™ smRoman
    5: 0,  # langSwedish Ã¢â€ â€™ smRoman
    6: 0,  # langSpanish Ã¢â€ â€™ smRoman
    7: 0,  # langDanish Ã¢â€ â€™ smRoman
    8: 0,  # langPortuguese Ã¢â€ â€™ smRoman
    9: 0,  # langNorwegian Ã¢â€ â€™ smRoman
    10: 5,  # langHebrew Ã¢â€ â€™ smHebrew
    11: 1,  # langJapanese Ã¢â€ â€™ smJapanese
    12: 4,  # langArabic Ã¢â€ â€™ smArabic
    13: 0,  # langFinnish Ã¢â€ â€™ smRoman
    14: 6,  # langGreek Ã¢â€ â€™ smGreek
    15: 0,  # langIcelandic Ã¢â€ â€™ smRoman (modified)
    16: 0,  # langMaltese Ã¢â€ â€™ smRoman
    17: 0,  # langTurkish Ã¢â€ â€™ smRoman (modified)
    18: 0,  # langCroatian Ã¢â€ â€™ smRoman (modified)
    19: 2,  # langTradChinese Ã¢â€ â€™ smTradChinese
    20: 4,  # langUrdu Ã¢â€ â€™ smArabic
    21: 9,  # langHindi Ã¢â€ â€™ smDevanagari
    22: 21,  # langThai Ã¢â€ â€™ smThai
    23: 3,  # langKorean Ã¢â€ â€™ smKorean
    24: 29,  # langLithuanian Ã¢â€ â€™ smCentralEuroRoman
    25: 29,  # langPolish Ã¢â€ â€™ smCentralEuroRoman
    26: 29,  # langHungarian Ã¢â€ â€™ smCentralEuroRoman
    27: 29,  # langEstonian Ã¢â€ â€™ smCentralEuroRoman
    28: 29,  # langLatvian Ã¢â€ â€™ smCentralEuroRoman
    29: 0,  # langSami Ã¢â€ â€™ smRoman
    30: 0,  # langFaroese Ã¢â€ â€™ smRoman (modified)
    31: 4,  # langFarsi Ã¢â€ â€™ smArabic (modified)
    32: 7,  # langRussian Ã¢â€ â€™ smCyrillic
    33: 25,  # langSimpChinese Ã¢â€ â€™ smSimpChinese
    34: 0,  # langFlemish Ã¢â€ â€™ smRoman
    35: 0,  # langIrishGaelic Ã¢â€ â€™ smRoman (modified)
    36: 0,  # langAlbanian Ã¢â€ â€™ smRoman
    37: 0,  # langRomanian Ã¢â€ â€™ smRoman (modified)
    38: 29,  # langCzech Ã¢â€ â€™ smCentralEuroRoman
    39: 29,  # langSlovak Ã¢â€ â€™ smCentralEuroRoman
    40: 0,  # langSlovenian Ã¢â€ â€™ smRoman (modified)
    41: 5,  # langYiddish Ã¢â€ â€™ smHebrew
    42: 7,  # langSerbian Ã¢â€ â€™ smCyrillic
    43: 7,  # langMacedonian Ã¢â€ â€™ smCyrillic
    44: 7,  # langBulgarian Ã¢â€ â€™ smCyrillic
    45: 7,  # langUkrainian Ã¢â€ â€™ smCyrillic (modified)
    46: 7,  # langByelorussian Ã¢â€ â€™ smCyrillic
    47: 7,  # langUzbek Ã¢â€ â€™ smCyrillic
    48: 7,  # langKazakh Ã¢â€ â€™ smCyrillic
    49: 7,  # langAzerbaijani Ã¢â€ â€™ smCyrillic
    50: 4,  # langAzerbaijanAr Ã¢â€ â€™ smArabic
    51: 24,  # langArmenian Ã¢â€ â€™ smArmenian
    52: 23,  # langGeorgian Ã¢â€ â€™ smGeorgian
    53: 7,  # langMoldavian Ã¢â€ â€™ smCyrillic
    54: 7,  # langKirghiz Ã¢â€ â€™ smCyrillic
    55: 7,  # langTajiki Ã¢â€ â€™ smCyrillic
    56: 7,  # langTurkmen Ã¢â€ â€™ smCyrillic
    57: 27,  # langMongolian Ã¢â€ â€™ smMongolian
    58: 7,  # langMongolianCyr Ã¢â€ â€™ smCyrillic
    59: 4,  # langPashto Ã¢â€ â€™ smArabic
    60: 4,  # langKurdish Ã¢â€ â€™ smArabic
    61: 4,  # langKashmiri Ã¢â€ â€™ smArabic
    62: 4,  # langSindhi Ã¢â€ â€™ smArabic
    63: 26,  # langTibetan Ã¢â€ â€™ smTibetan
    64: 9,  # langNepali Ã¢â€ â€™ smDevanagari
    65: 9,  # langSanskrit Ã¢â€ â€™ smDevanagari
    66: 9,  # langMarathi Ã¢â€ â€™ smDevanagari
    67: 13,  # langBengali Ã¢â€ â€™ smBengali
    68: 13,  # langAssamese Ã¢â€ â€™ smBengali
    69: 11,  # langGujarati Ã¢â€ â€™ smGujarati
    70: 10,  # langPunjabi Ã¢â€ â€™ smGurmukhi
    71: 12,  # langOriya Ã¢â€ â€™ smOriya
    72: 17,  # langMalayalam Ã¢â€ â€™ smMalayalam
    73: 16,  # langKannada Ã¢â€ â€™ smKannada
    74: 14,  # langTamil Ã¢â€ â€™ smTamil
    75: 15,  # langTelugu Ã¢â€ â€™ smTelugu
    76: 18,  # langSinhalese Ã¢â€ â€™ smSinhalese
    77: 19,  # langBurmese Ã¢â€ â€™ smBurmese
    78: 20,  # langKhmer Ã¢â€ â€™ smKhmer
    79: 22,  # langLao Ã¢â€ â€™ smLao
    80: 30,  # langVietnamese Ã¢â€ â€™ smVietnamese
    81: 0,  # langIndonesian Ã¢â€ â€™ smRoman
    82: 0,  # langTagalog Ã¢â€ â€™ smRoman
    83: 0,  # langMalayRoman Ã¢â€ â€™ smRoman
    84: 4,  # langMalayArabic Ã¢â€ â€™ smArabic
    85: 28,  # langAmharic Ã¢â€ â€™ smEthiopic
    86: 28,  # langTigrinya Ã¢â€ â€™ smEthiopic
    87: 28,  # langOromo Ã¢â€ â€™ smEthiopic
    88: 0,  # langSomali Ã¢â€ â€™ smRoman
    89: 0,  # langSwahili Ã¢â€ â€™ smRoman
    90: 0,  # langKinyarwanda Ã¢â€ â€™ smRoman
    91: 0,  # langRundi Ã¢â€ â€™ smRoman
    92: 0,  # langNyanja Ã¢â€ â€™ smRoman
    93: 0,  # langMalagasy Ã¢â€ â€™ smRoman
    94: 0,  # langEsperanto Ã¢â€ â€™ smRoman
    128: 0,  # langWelsh Ã¢â€ â€™ smRoman (modified)
    129: 0,  # langBasque Ã¢â€ â€™ smRoman
    130: 0,  # langCatalan Ã¢â€ â€™ smRoman
    131: 0,  # langLatin Ã¢â€ â€™ smRoman
    132: 0,  # langQuechua Ã¢â€ â€™ smRoman
    133: 0,  # langGuarani Ã¢â€ â€™ smRoman
    134: 0,  # langAymara Ã¢â€ â€™ smRoman
    135: 7,  # langTatar Ã¢â€ â€™ smCyrillic
    136: 4,  # langUighur Ã¢â€ â€™ smArabic
    137: 26,  # langDzongkha Ã¢â€ â€™ smTibetan
    138: 0,  # langJavaneseRom Ã¢â€ â€™ smRoman
    139: 0,  # langSundaneseRom Ã¢â€ â€™ smRoman
    140: 0,  # langGalician Ã¢â€ â€™ smRoman
    141: 0,  # langAfrikaans Ã¢â€ â€™ smRoman
    142: 0,  # langBreton Ã¢â€ â€™ smRoman (modified)
    143: 28,  # langInuktitut Ã¢â€ â€™ smEthiopic (modified)
    144: 0,  # langScottishGaelic Ã¢â€ â€™ smRoman (modified)
    145: 0,  # langManxGaelic Ã¢â€ â€™ smRoman (modified)
    146: 0,  # langIrishGaelicScript Ã¢â€ â€™ smRoman (modified)
    147: 0,  # langTongan Ã¢â€ â€™ smRoman
    148: 6,  # langGreekAncient Ã¢â€ â€™ smRoman
    149: 0,  # langGreenlandic Ã¢â€ â€™ smRoman
    150: 0,  # langAzerbaijanRoman Ã¢â€ â€™ smRoman
    151: 0,  # langNynorsk Ã¢â€ â€™ smRoman
}
