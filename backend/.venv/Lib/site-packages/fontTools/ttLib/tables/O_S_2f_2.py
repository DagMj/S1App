...
def calcCodePageRanges(unicodes):
    ...
    hasLineart = ord("Ã¢â€Â¤") in unicodes

    for uni in unicodes:
        if uni == ord("ÃƒÅ¾") and hasAscii:
            bits.add(0)  # Latin 1
        elif uni == ord("Ã„Â½") and hasAscii:
            bits.add(1)  # Latin 2: Eastern Europe
            if hasLineart:
                bits.add(58)  # Latin 2
        elif uni == ord("Ãâ€˜"):
            bits.add(2)  # Cyrillic
            if ord("Ãâ€¦") in unicodes and hasLineart:
                bits.add(57)  # IBM Cyrillic
            if ord("Ã¢â€¢Å“") in unicodes and hasLineart:
                bits.add(49)  # MS-DOS Russian
        elif uni == ord("ÃŽâ€ "):
            bits.add(3)  # Greek
            if hasLineart and ord("Ã‚Â½") in unicodes:
                bits.add(48)  # IBM Greek
            if hasLineart and ord("Ã¢Ë†Å¡") in unicodes:
        ...
        elif uni == ord("Ã¢â€šÂ«") and hasAscii:
        ...
        elif uni == ord("Ã¢â„¢Â¥") and hasAscii:
        ...
        elif uni == ord("ÃƒÂ¾") and hasAscii and hasLineart:
            bits.add(54)  # MS-DOS Icelandic
        elif uni == ord("Ã¢â€¢Å¡") and hasAscii:
            bits.add(62)  # WE/Latin 1
            bits.add(63)  # US
        elif hasAscii and hasLineart and ord("Ã¢Ë†Å¡") in unicodes:
            if uni == ord("Ãƒâ€¦"):
    ...
    if hasAscii and ord("Ã¢â‚¬Â°") in unicodes and ord("Ã¢Ë†â€˜") in unicodes:
