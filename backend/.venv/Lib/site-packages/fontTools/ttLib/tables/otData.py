otData = [
    ...
    (
        ...
        [
            ...
            (
                ...
                32,
                0,
                "These are the FUnit distance deltas from the fontÃ¢â‚¬â„¢s natural baseline to the other baselines used in the font. A total of 32 deltas must be assigned.",
            ),
        ],
    ),
    (
    ...
    # Apple TrueType Reference Manual, chapter Ã¢â‚¬Å“The Ã¢â‚¬ËœmorxÃ¢â‚¬â„¢ tableÃ¢â‚¬Â,
    # section Ã¢â‚¬Å“Metamorphosis SubtablesÃ¢â‚¬Â.
    ...
    (
        ...
        [
            (
                ...
                None,
                None,
                "Version number of the AAT glyphs property table. Version 1.0 is the initial table version. Version 2.0, which is recognized by macOS 8.5 and later, adds support for the Ã¢â‚¬Å“attaches on rightÃ¢â‚¬Â bit. Version 3.0, which gets recognized by macOS X and iOS, adds support for the additional directional properties defined in Unicode 3.0.",
            ),
    ...
    (
        ...
        [
            ...
            (
                ...
                "AxisCount",
                0,
                'The segment maps array Ã¢â‚¬â€ one segment map for each axis, in the order of axes specified in the "fvar" table',
            ),
            (
                "LOffsetTo(DeltaSetIndexMap)",
                "VarIdxMap",
