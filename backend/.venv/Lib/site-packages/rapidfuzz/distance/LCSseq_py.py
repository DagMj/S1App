...
def editops(
    ...
    *,
    ...
    Notes
    -----
    The alignment is calculated using an algorithm of Heikki HyyrÃƒÂ¶, which is
    described in [6]_. It has a time complexity and memory usage of ``O([N/64] * M)``.

    References
    ----------
    .. [6] HyyrÃƒÂ¶, Heikki. "A Note on Bit-Parallel Alignment Computation."
           Stringology (2004).
...
def opcodes(
    ...
    *,
    ...
    References
    ----------
    .. [7] HyyrÃƒÂ¶, Heikki. "A Note on Bit-Parallel Alignment Computation."
           Stringology (2004).
