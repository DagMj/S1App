...
def mannwhitneyu(x, y, use_continuity=True, alternative="two-sided",
    ...
    alternative : {'two-sided', 'less', 'greater'}, optional
        ...
        * 'two-sided': the distributions are not equal, i.e. *SX(u) Ã¢â€°Â  SY(u)* for
          at least one *u*.
    ...
    .. [3] Andreas LÃƒÂ¶ffler,
           "ÃƒÅ“ber eine Partition der nat. Zahlen und ihr Anwendung beim U-Test",
