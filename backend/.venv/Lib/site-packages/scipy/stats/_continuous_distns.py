...
class genhyperbolic_gen(rv_continuous):
    ...
    .. [3] Scott, David J, WÃƒÂ¼rtz, Diethelm, Dong, Christine and Tran,
...
class invweibull_gen(rv_continuous):
    ...
    This distribution is also known as the FrÃƒÂ©chet distribution or the
...
class laplace_asymmetric_gen(rv_continuous):
    ...
    .. [2] Kozubowski TJ and PodgÃƒÂ³rski K. A Multivariate and
...
# same as above, but using -exp(x) = exp(x + Ãâ‚¬i)
...
class studentized_range_gen(rv_continuous):
    ...
    for :math:`x Ã¢â€°Â¥ 0`, :math:`k > 1`, and :math:`\nu > 0`.
    ...
    .. [2] Batista, Ben DÃƒÂªivide, et al. "Externally Studentized Normal Midrange
           Distribution." CiÃƒÂªncia e Agrotecnologia, vol. 41, no. 4, 2017, pp.
