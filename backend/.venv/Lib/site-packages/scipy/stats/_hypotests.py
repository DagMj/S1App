...
def _psi1_mod(x):
    """
    psi1 is defined in equation 1.10 in CsÃƒÂ¶rgÃ…â€˜, S. and Faraway, J. (1996).
...
def _cdf_cvm_inf(x):
    """
    Calculate the cdf of the CramÃƒÂ©r-von Mises statistic (infinite sample size).

    See equation 1.2 in CsÃƒÂ¶rgÃ…â€˜, S. and Faraway, J. (1996).
...
def _cdf_cvm(x, n=None):
    """
    Calculate the cdf of the CramÃƒÂ©r-von Mises statistic for a finite sample
    size n. If N is None, use the asymptotic cdf (n=inf).

    See equation 1.8 in CsÃƒÂ¶rgÃ…â€˜, S. and Faraway, J. (1996) for finite samples,
    ...
    and 1, respectively. These are limitations of the approximation by CsÃƒÂ¶rgÃ…â€˜
...
def cramervonmises(rvs, cdf, args=()):
    """Perform the one-sample CramÃƒÂ©r-von Mises test for goodness of fit.
    ...
    References
    ----------
    .. [1] CramÃƒÂ©r-von Mises criterion, Wikipedia,
           https://en.wikipedia.org/wiki/Cram%C3%A9r%E2%80%93von_Mises_criterion
    .. [2] CsÃƒÂ¶rgÃ…â€˜, S. and Faraway, J. (1996). The Exact and Asymptotic
           Distribution of CramÃƒÂ©r-von Mises Statistics. Journal of the
...
def _pval_cvm_2samp_exact(s, m, n):
    ...
    [1] Y. Xiao, A. Gordon, and A. Yakovlev, "A C++ Program for
        the CramÃƒÂ©r-Von Mises Two-Sample Test", J. Stat. Soft.,
...
def cramervonmises_2samp(x, y, method='auto'):
    """Perform the two-sample CramÃƒÂ©r-von Mises test for goodness of fit.

    This is the two-sample version of the CramÃƒÂ©r-von Mises test ([1]_):
