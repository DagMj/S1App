...
class _ProbabilityDistribution(ABC):
    ...
    def cdf(self, x, y, /, *, method):
        ...
        The CDF evaluates to its minimum value of :math:`0` for :math:`x Ã¢â€°Â¤ l`
        and its maximum value of :math:`1` for :math:`x Ã¢â€°Â¥ r`.
    ...
    def ccdf(self, x, y, /, *, method):
        ...
        The CCDF returns its minimum value of :math:`0` for :math:`x Ã¢â€°Â¥ r`
        and its maximum value of :math:`1` for :math:`x Ã¢â€°Â¤ l`.
    ...
    def logcdf(self, x, y, /, *, method):
        ...
        for :math:`x Ã¢â€°Â¤ l` and its maximum value of :math:`\log(1) = 0` for
        :math:`x Ã¢â€°Â¥ r`.
    ...
    def ilogcdf(self, logp, /, *, method):
        ...
        `ilogcdf` accepts `logp` for :math:`\log(p) Ã¢â€°Â¤ 0`.
    ...
    def logccdf(self, x, y, /, *, method):
        ...
        :math:`x Ã¢â€°Â¥ r` and its maximum value of :math:`\log(1) = 0` for
        :math:`x Ã¢â€°Â¤ l`.
    ...
    def ilogccdf(self, logp, /, *, method):
        ...
        `ilogccdf` accepts `logp` for :math:`\log(p) Ã¢â€°Â¤ 0`.
