...
class TestRegression:
    ...
    def test_frompyfunc_name(self):
        ...
        f = np.frompyfunc(cassÃƒÂ©, 1, 1)
        assert str(f) == "<ufunc 'cassÃƒÂ© (vectorized)'>"
    ...
    def test_vectorize_fixed_width_string(self):
        arr = np.array(["SOme wOrd Ã‡â€ž ÃƒÅ¸ Ã¡Â¾â€º ÃŽÂ£ÃŽÂ£ Ã¯Â¬Æ’Ã¢ÂÂµÃƒâ€¦ Ãƒâ€¡ Ã¢â€¦Â "]).astype(np.str_)
        f = str.casefold
