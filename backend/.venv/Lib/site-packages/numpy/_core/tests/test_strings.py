...
class TestMethods:
    ...
    @pytest.mark.parametrize("a,sub,start,end,out", [
        ...
        (["abcdefghiabc", "rrarrrrrrrrra"], ["def", "arr"], [0, 3],
         None, [3, -1]),
        ("AeÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ Ã°Å¸ËœÅ " * 2, "Ã°Å¸ËœÅ ", 0, None, 6),
        ("AeÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ Ã°Å¸ËœÅ " * 2, "Ã°Å¸ËœÅ ", 7, None, 13),
    ])
    def test_find(self, a, sub, start, end, out, dt):
        if "Ã°Å¸ËœÅ " in a and dt == "S":
    ...
    @pytest.mark.parametrize("a,sub,start,end,out", [
        ...
        (["abcdefghiabc", "rrarrrrrrrrra"], ["abc", "a"], [0, 0],
         None, [9, 12]),
        ("AeÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ Ã°Å¸ËœÅ " * 2, "Ã°Å¸ËœÅ ", 0, None, 13),
        ("AeÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ Ã°Å¸ËœÅ " * 2, "Ã°Å¸ËœÅ ", 0, 7, 6),
    ])
    ...
    @pytest.mark.parametrize("a,sub,start,end,out", [
        ...
        ("", "xx", MAX, 0, 0),
        (["aaa", ""], ["a", ""], [0, 0], None, [3, 1]),
        ("AeÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ Ã°Å¸ËœÅ " * 100, "Ã°Å¸ËœÅ ", 0, None, 100),
    ])
...
class TestMethodsWithUnicode:
    ...
    @pytest.mark.parametrize("buf,old,new,count,res", [
        ("...\u043c......<", "<", "&lt;", -1, "...\u043c......&lt;"),
        ("AeÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ Ã°Å¸ËœÅ " * 2, "A", "B", -1, "BeÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ Ã°Å¸ËœÅ BeÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ Ã°Å¸ËœÅ "),
        ("AeÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ Ã°Å¸ËœÅ " * 2, "Ã°Å¸ËœÅ ", "B", -1, "AeÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ BAeÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ B"),
    ])
    ...
    def test_index_raises_unicode(self, dt):
        with pytest.raises(ValueError, match="substring not found"):
            np.strings.index("AeÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ Ã°Å¸ËœÅ ", "Ã°Å¸Ëœâ‚¬")

    @pytest.mark.parametrize("buf,res", [
        ("AeÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ \t Ã°Å¸ËœÅ ", "AeÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬    Ã°Å¸ËœÅ "),
        ("\t\U0001044E", "        \U0001044E"),
    ])
    ...
    @pytest.mark.parametrize("buf,sep,res1,res2,res3", [
        ("Ã„ÂÃ„ÂÃ„ÂÃ„ÂÃ„â‚¬Ã„â‚¬Ã„â‚¬Ã„â‚¬", "Ã„â€š", "Ã„ÂÃ„ÂÃ„ÂÃ„ÂÃ„â‚¬Ã„â‚¬Ã„â‚¬Ã„â‚¬", "", ""),
        ("Ã„ÂÃ„ÂÃ„ÂÃ„ÂÃ„â€šÃ„â‚¬Ã„â‚¬Ã„â‚¬Ã„â‚¬", "Ã„â€š", "Ã„ÂÃ„ÂÃ„ÂÃ„Â", "Ã„â€š", "Ã„â‚¬Ã„â‚¬Ã„â‚¬Ã„â‚¬"),
        ("Ã„ÂÃ„ÂÃ„ÂÃ„ÂÃ„â€šÃ„â€šÃ„â‚¬Ã„â‚¬Ã„â‚¬Ã„â‚¬", "Ã„â€šÃ„â€š", "Ã„ÂÃ„ÂÃ„ÂÃ„Â", "Ã„â€šÃ„â€š", "Ã„â‚¬Ã„â‚¬Ã„â‚¬Ã„â‚¬"),
        ("Ã°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’â‚¬Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬", "Ã°ÂÅ’â€š", "Ã°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’â‚¬Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬", "", ""),
        ("Ã°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’â€šÃ°ÂÅ’â‚¬Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬", "Ã°ÂÅ’â€š", "Ã°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’Â", "Ã°ÂÅ’â€š", "Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬"),
        ("Ã°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’â€šÃ°ÂÅ’â€šÃ°ÂÅ’â‚¬Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬", "Ã°ÂÅ’â€šÃ°ÂÅ’â€š", "Ã°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’Â", "Ã°ÂÅ’â€šÃ°ÂÅ’â€š", "Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬"),
        ("Ã°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’â€šÃ°ÂÅ’â€šÃ°ÂÅ’â€šÃ°ÂÅ’â€šÃ°ÂÅ’â‚¬Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬", "Ã°ÂÅ’â€šÃ°ÂÅ’â€šÃ°ÂÅ’â€šÃ°ÂÅ’â€š", "Ã°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’ÂÃ°ÂÅ’Â", "Ã°ÂÅ’â€šÃ°ÂÅ’â€šÃ°ÂÅ’â€šÃ°ÂÅ’â€š", "Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬Ã°ÂÅ’â‚¬"),
    ])
    def test_partition(self, buf, sep, res1, res2, res3, dt):
        buf = np.array(buf, dtype=dt)
        sep = np.array(sep, dtype=dt)
...
class TestMixedTypeMethods:
    def test_center(self):
        buf = np.array("Ã°Å¸ËœÅ ", dtype="U")
        fill = np.array("*", dtype="S")
        res = np.array("*Ã°Å¸ËœÅ *", dtype="U")
