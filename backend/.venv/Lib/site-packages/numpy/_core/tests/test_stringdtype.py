...
@pytest.fixture
def string_list():
    return ["abc", "def", "ghi" * 10, "AÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ Ã°Å¸ËœÅ " * 100, "Abc" * 1000, "DEF"]
...
@pytest.mark.parametrize(
    ...
    [
        ["abc", "def", "ghi"],
        ["Ã°Å¸Â¤Â£", "Ã°Å¸â€œÂµ", "Ã°Å¸ËœÂ°"],
        ["Ã°Å¸Å¡Å“", "Ã°Å¸â„¢Æ’", "Ã°Å¸ËœÂ¾"],
        ["Ã°Å¸ËœÂ¹", "Ã°Å¸Å¡Â ", "Ã°Å¸Å¡Å’"],
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ["this", "is", "an", "array"],
        ["Ã¢â€šÂ¬", "", "Ã°Å¸ËœÅ "],
        ["AÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ Ã°Å¸ËœÅ ", " AÃ¢ËœÆ’Ã¢â€šÂ¬Ã‚Â¢Ã°Å¸ËœÅ ", "Ã¢ËœÆ’Ã¢â€šÂ¬Ã°Å¸ËœÅ  AÃ‚Â¢", "Ã°Å¸ËœÅ Ã¢ËœÆ’AÃ‚Â¢ Ã¢â€šÂ¬"],
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["Ã°Å¸Â¤Â£Ã°Å¸Â¤Â£", "Ã°Å¸Â¤Â£", "Ã°Å¸â€œÂµ", "Ã°Å¸ËœÂ°"],
        ["Ã°Å¸Å¡Å“", "Ã°Å¸â„¢Æ’", "Ã°Å¸ËœÂ¾"],
        ["Ã°Å¸ËœÂ¹", "Ã°Å¸Å¡Â ", "Ã°Å¸Å¡Å’"],
        ["AÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ Ã°Å¸ËœÅ ", " AÃ¢ËœÆ’Ã¢â€šÂ¬Ã‚Â¢Ã°Å¸ËœÅ ", "Ã¢ËœÆ’Ã¢â€šÂ¬Ã°Å¸ËœÅ  AÃ‚Â¢", "Ã°Å¸ËœÅ Ã¢ËœÆ’AÃ‚Â¢ Ã¢â€šÂ¬"],
    ],
...
@pytest.mark.parametrize(
    ...
    [
        ["AÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ Ã°Å¸ËœÅ ", " AÃ¢ËœÆ’Ã¢â€šÂ¬Ã‚Â¢Ã°Å¸ËœÅ ", "Ã¢ËœÆ’Ã¢â€šÂ¬Ã°Å¸ËœÅ  AÃ‚Â¢", "Ã°Å¸ËœÅ Ã¢ËœÆ’AÃ‚Â¢ Ã¢â€šÂ¬"],
        ["AÃ‚Â¢Ã¢ËœÆ’Ã¢â€šÂ¬ Ã°Å¸ËœÅ ", "", " ", "Ã¯Ââ‚¬ "],
        ["", "a", "Ã°Å¸ËœÂ¸", "ÃƒÂ¡ÃƒÂ¡ÃƒÂ°fÃƒÂ¡ÃƒÂ­ÃƒÂ³ÃƒÂ¥ÃƒÂ©ÃƒÂ«"],
    ],
)
...
@pytest.mark.parametrize(
    "other_strings",
    [
        ["abc", "def" * 500, "ghi" * 16, "Ã°Å¸Â¤Â£" * 100, "Ã°Å¸â€œÂµ", "Ã°Å¸ËœÂ°"],
        ["Ã°Å¸Å¡Å“", "Ã°Å¸â„¢Æ’", "Ã°Å¸ËœÂ¾", "Ã°Å¸ËœÂ¹", "Ã°Å¸Å¡Â ", "Ã°Å¸Å¡Å’"],
        ["Ã°Å¸Â¥Â¦", "Ã‚Â¨", "Ã¢Â¨Â¯", "Ã¢Ë†Â° ", "Ã¢Â¨Å’ ", "Ã¢Å½Â¶ "],
    ],
)
...
def test_non_default_start_stop(function, start, stop, expected):
    a = np.array([["--Ã°Å¸ÂÂ--", "--Ã°Å¸Â¦Å“--"],
                  ["-Ã°Å¸ÂÂ---", "-Ã°Å¸Â¦Å“---"]], "T")
    indx = function(a, "Ã°Å¸ÂÂ", start, stop)
...
def test_replace_non_default_repeat(count):
    a = np.array(["Ã°Å¸ÂÂ--", "Ã°Å¸Â¦Å“-Ã°Å¸Â¦Å“-"], "T")
    result = np.strings.replace(a, "Ã°Å¸Â¦Å“-", "Ã°Å¸Â¦Å“Ã¢â‚¬Â ", count)
    assert_array_equal(result, np.array(["Ã°Å¸ÂÂ--", "Ã°Å¸Â¦Å“Ã¢â‚¬Â Ã°Å¸Â¦Å“Ã¢â‚¬Â "], "T"))
...
class TestImplementation:
    ...
    def test_arena_reuse_if_possible(self):
        ...
        c[:] = self.s_medium + "Ã‚Â±"
        assert_array_equal(c, self.s_medium + "Ã‚Â±")
