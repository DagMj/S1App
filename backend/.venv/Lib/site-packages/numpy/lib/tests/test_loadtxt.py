...
@pytest.mark.parametrize("c1", ["a", "Ã£ÂÂ®", "Ã°Å¸Â«â€¢"])
@pytest.mark.parametrize("c2", ["a", "Ã£ÂÂ®", "Ã°Å¸Â«â€¢"])
...
def test_unicode_with_converter():
    ...
    expected = np.array([['CAT', 'dog'], ['ÃŽâ€˜ÃŽâ€™ÃŽâ€œ', 'ÃŽÂ´ÃŽÂµÃŽÂ¶'], ['ABC', 'def']])
    assert_equal(res, expected)
