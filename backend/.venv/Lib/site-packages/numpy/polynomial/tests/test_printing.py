...
class TestStrUnicodeSuperSubscripts:
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ([1, 2, 3], "1.0 + 2.0Ã‚Â·x + 3.0Ã‚Â·xÃ‚Â²"),
        ([-1, 0, 3, -1], "-1.0 + 0.0Ã‚Â·x + 3.0Ã‚Â·xÃ‚Â² - 1.0Ã‚Â·xÃ‚Â³"),
        (arange(12), ("0.0 + 1.0Ã‚Â·x + 2.0Ã‚Â·xÃ‚Â² + 3.0Ã‚Â·xÃ‚Â³ + 4.0Ã‚Â·xÃ¢ÂÂ´ + 5.0Ã‚Â·xÃ¢ÂÂµ + "
                      "6.0Ã‚Â·xÃ¢ÂÂ¶ + 7.0Ã‚Â·xÃ¢ÂÂ· +\n8.0Ã‚Â·xÃ¢ÂÂ¸ + 9.0Ã‚Â·xÃ¢ÂÂ¹ + 10.0Ã‚Â·xÃ‚Â¹Ã¢ÂÂ° + "
                      "11.0Ã‚Â·xÃ‚Â¹Ã‚Â¹")),
    ))
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ([1, 2, 3], "1.0 + 2.0Ã‚Â·TÃ¢â€šÂ(x) + 3.0Ã‚Â·TÃ¢â€šâ€š(x)"),
        ([-1, 0, 3, -1], "-1.0 + 0.0Ã‚Â·TÃ¢â€šÂ(x) + 3.0Ã‚Â·TÃ¢â€šâ€š(x) - 1.0Ã‚Â·TÃ¢â€šÆ’(x)"),
        (arange(12), ("0.0 + 1.0Ã‚Â·TÃ¢â€šÂ(x) + 2.0Ã‚Â·TÃ¢â€šâ€š(x) + 3.0Ã‚Â·TÃ¢â€šÆ’(x) + 4.0Ã‚Â·TÃ¢â€šâ€ž(x) + "
                      "5.0Ã‚Â·TÃ¢â€šâ€¦(x) +\n6.0Ã‚Â·TÃ¢â€šâ€ (x) + 7.0Ã‚Â·TÃ¢â€šâ€¡(x) + 8.0Ã‚Â·TÃ¢â€šË†(x) + "
                      "9.0Ã‚Â·TÃ¢â€šâ€°(x) + 10.0Ã‚Â·TÃ¢â€šÂÃ¢â€šâ‚¬(x) + 11.0Ã‚Â·TÃ¢â€šÂÃ¢â€šÂ(x)")),
    ))
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ([1, 2, 3], "1.0 + 2.0Ã‚Â·PÃ¢â€šÂ(x) + 3.0Ã‚Â·PÃ¢â€šâ€š(x)"),
        ([-1, 0, 3, -1], "-1.0 + 0.0Ã‚Â·PÃ¢â€šÂ(x) + 3.0Ã‚Â·PÃ¢â€šâ€š(x) - 1.0Ã‚Â·PÃ¢â€šÆ’(x)"),
        (arange(12), ("0.0 + 1.0Ã‚Â·PÃ¢â€šÂ(x) + 2.0Ã‚Â·PÃ¢â€šâ€š(x) + 3.0Ã‚Â·PÃ¢â€šÆ’(x) + 4.0Ã‚Â·PÃ¢â€šâ€ž(x) + "
                      "5.0Ã‚Â·PÃ¢â€šâ€¦(x) +\n6.0Ã‚Â·PÃ¢â€šâ€ (x) + 7.0Ã‚Â·PÃ¢â€šâ€¡(x) + 8.0Ã‚Â·PÃ¢â€šË†(x) + "
                      "9.0Ã‚Â·PÃ¢â€šâ€°(x) + 10.0Ã‚Â·PÃ¢â€šÂÃ¢â€šâ‚¬(x) + 11.0Ã‚Â·PÃ¢â€šÂÃ¢â€šÂ(x)")),
    ))
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ([1, 2, 3], "1.0 + 2.0Ã‚Â·HÃ¢â€šÂ(x) + 3.0Ã‚Â·HÃ¢â€šâ€š(x)"),
        ([-1, 0, 3, -1], "-1.0 + 0.0Ã‚Â·HÃ¢â€šÂ(x) + 3.0Ã‚Â·HÃ¢â€šâ€š(x) - 1.0Ã‚Â·HÃ¢â€šÆ’(x)"),
        (arange(12), ("0.0 + 1.0Ã‚Â·HÃ¢â€šÂ(x) + 2.0Ã‚Â·HÃ¢â€šâ€š(x) + 3.0Ã‚Â·HÃ¢â€šÆ’(x) + 4.0Ã‚Â·HÃ¢â€šâ€ž(x) + "
                      "5.0Ã‚Â·HÃ¢â€šâ€¦(x) +\n6.0Ã‚Â·HÃ¢â€šâ€ (x) + 7.0Ã‚Â·HÃ¢â€šâ€¡(x) + 8.0Ã‚Â·HÃ¢â€šË†(x) + "
                      "9.0Ã‚Â·HÃ¢â€šâ€°(x) + 10.0Ã‚Â·HÃ¢â€šÂÃ¢â€šâ‚¬(x) + 11.0Ã‚Â·HÃ¢â€šÂÃ¢â€šÂ(x)")),
    ))
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ([1, 2, 3], "1.0 + 2.0Ã‚Â·HeÃ¢â€šÂ(x) + 3.0Ã‚Â·HeÃ¢â€šâ€š(x)"),
        ([-1, 0, 3, -1], "-1.0 + 0.0Ã‚Â·HeÃ¢â€šÂ(x) + 3.0Ã‚Â·HeÃ¢â€šâ€š(x) - 1.0Ã‚Â·HeÃ¢â€šÆ’(x)"),
        (arange(12), ("0.0 + 1.0Ã‚Â·HeÃ¢â€šÂ(x) + 2.0Ã‚Â·HeÃ¢â€šâ€š(x) + 3.0Ã‚Â·HeÃ¢â€šÆ’(x) + "
                      "4.0Ã‚Â·HeÃ¢â€šâ€ž(x) + 5.0Ã‚Â·HeÃ¢â€šâ€¦(x) +\n6.0Ã‚Â·HeÃ¢â€šâ€ (x) + 7.0Ã‚Â·HeÃ¢â€šâ€¡(x) + "
                      "8.0Ã‚Â·HeÃ¢â€šË†(x) + 9.0Ã‚Â·HeÃ¢â€šâ€°(x) + 10.0Ã‚Â·HeÃ¢â€šÂÃ¢â€šâ‚¬(x) +\n"
                      "11.0Ã‚Â·HeÃ¢â€šÂÃ¢â€šÂ(x)")),
    ))
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ([1, 2, 3], "1.0 + 2.0Ã‚Â·LÃ¢â€šÂ(x) + 3.0Ã‚Â·LÃ¢â€šâ€š(x)"),
        ([-1, 0, 3, -1], "-1.0 + 0.0Ã‚Â·LÃ¢â€šÂ(x) + 3.0Ã‚Â·LÃ¢â€šâ€š(x) - 1.0Ã‚Â·LÃ¢â€šÆ’(x)"),
        (arange(12), ("0.0 + 1.0Ã‚Â·LÃ¢â€šÂ(x) + 2.0Ã‚Â·LÃ¢â€šâ€š(x) + 3.0Ã‚Â·LÃ¢â€šÆ’(x) + 4.0Ã‚Â·LÃ¢â€šâ€ž(x) + "
                      "5.0Ã‚Â·LÃ¢â€šâ€¦(x) +\n6.0Ã‚Â·LÃ¢â€šâ€ (x) + 7.0Ã‚Â·LÃ¢â€šâ€¡(x) + 8.0Ã‚Â·LÃ¢â€šË†(x) + "
                      "9.0Ã‚Â·LÃ¢â€šâ€°(x) + 10.0Ã‚Â·LÃ¢â€šÂÃ¢â€šâ‚¬(x) + 11.0Ã‚Â·LÃ¢â€šÂÃ¢â€šÂ(x)")),
    ))
...
def test_set_default_printoptions():
    ...
    poly.set_default_printstyle('unicode')
    assert_equal(str(p), "1.0 + 2.0Ã‚Â·x + 3.0Ã‚Â·xÃ‚Â²")
    assert_equal(str(c), "1.0 + 2.0Ã‚Â·TÃ¢â€šÂ(x) + 3.0Ã‚Â·TÃ¢â€šâ€š(x)")
...
def test_complex_coefficients():
    ...
    poly.set_default_printstyle('unicode')
    assert_equal(str(p1), "1j + (1+1j)Ã‚Â·x - (2-2j)Ã‚Â·xÃ‚Â² + (3+0j)Ã‚Â·xÃ‚Â³")
    assert_equal(str(p2), "1j + (1+1j)Ã‚Â·x + (-2+2j)Ã‚Â·xÃ‚Â² + (3+0j)Ã‚Â·xÃ‚Â³")
    poly.set_default_printstyle('ascii')
...
@pytest.mark.parametrize(('coefs', 'tgt'), (
    (array([1, 2, 'f'], dtype=object), '1 + 2Ã‚Â·x + fÃ‚Â·xÃ‚Â²'),
    (array([1, 2, [3, 4]], dtype=object), '1 + 2Ã‚Â·x + [3, 4]Ã‚Â·xÃ‚Â²'),
))
...
class TestFormat:
    def test_format_unicode(self):
        ...
        assert_equal(format(p, 'unicode'), "1.0 + 2.0Ã‚Â·x + 0.0Ã‚Â·xÃ‚Â² - 1.0Ã‚Â·xÃ‚Â³")
...
@pytest.mark.parametrize(('poly', 'tgt'), (
    (poly.Polynomial, '1.0 + 2.0Ã‚Â·z + 3.0Ã‚Â·zÃ‚Â²'),
    (poly.Chebyshev, '1.0 + 2.0Ã‚Â·TÃ¢â€šÂ(z) + 3.0Ã‚Â·TÃ¢â€šâ€š(z)'),
    (poly.Hermite, '1.0 + 2.0Ã‚Â·HÃ¢â€šÂ(z) + 3.0Ã‚Â·HÃ¢â€šâ€š(z)'),
    (poly.HermiteE, '1.0 + 2.0Ã‚Â·HeÃ¢â€šÂ(z) + 3.0Ã‚Â·HeÃ¢â€šâ€š(z)'),
    (poly.Laguerre, '1.0 + 2.0Ã‚Â·LÃ¢â€šÂ(z) + 3.0Ã‚Â·LÃ¢â€šâ€š(z)'),
    (poly.Legendre, '1.0 + 2.0Ã‚Â·PÃ¢â€šÂ(z) + 3.0Ã‚Â·PÃ¢â€šâ€š(z)'),
))
