...
if __name__ == "__main__":  # pragma: no cover
    ...
    def bar(
        a: Any,
    ) -> None:  # Ã¨Â¿â„¢Ã¦ËœÂ¯Ã¥Â¯Â¹Ã¤ÂºÅ¡Ã¦Â´Â²Ã¨Â¯Â­Ã¨Â¨â‚¬Ã¦â€Â¯Ã¦Å’ÂÃ§Å¡â€žÃ¦Âµâ€¹Ã¨Â¯â€¢Ã£â‚¬â€šÃ©ÂÂ¢Ã¥Â¯Â¹Ã¦Â¨Â¡Ã¦Â£Â±Ã¤Â¸Â¤Ã¥ÂÂ¯Ã§Å¡â€žÃ¦Æ’Â³Ã¦Â³â€¢Ã¯Â¼Å’Ã¦â€¹â€™Ã§Â»ÂÃ§Å’Å“Ã¦Âµâ€¹Ã§Å¡â€žÃ¨Â¯Â±Ã¦Æ’â€˜
        one = 1
        print(one / a)
